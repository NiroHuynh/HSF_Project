    ...
    VALUES
        (N'Joker: Folie à Deux',
         ...
         '2026-09-15', 'https://upload.wikimedia.org/wikipedia/vi/7/79/JOKER_FOLIE_%C3%80_DEUX_-_Vietnam_poster.jpg',
        ...
        (N'Dune: Part Two',
         ...
         '2026-04-01', 'https://m.media-amazon.com/images/M/MV5BZWI5NWQwY2QtZTc0Mi00YWE4LTkzMGQtZDA1NTI3NzAwODU2XkEyXkFqcGc@._V1_FMjpg_UY2048_.jpg',
    ...
    /* ============================================================
       ...
       ── Cinema 7 (IMAX, 82 ghế) — layout A–G khớp ảnh Chọn ghế:
            A, B, C = STANDARD × 12 mỗi hàng
            D, E, F       = VIP      × 12 mỗi hàng
            G          = SWEETBOX × 10
            Tổng = 12×6 + 10 = 82 ✓
